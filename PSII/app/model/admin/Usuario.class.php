...
class Usuario extends TRecord
{
    ...
    public function __construct($id = NULL)
    {
        ...
        parent::addAttribute('lgn_usr_nome');
        parent::addAttribute('lgn_usuario');
        parent::addAttribute('lgn_senha');
   ...
   /**
    ...
    public function addSystemUserGroup(SystemGroup $systemusergroup)
    {
        ...
        $object->system_user_id = $this->lgn_id;
        $object->store();
    }
    ...
    public function getSystemUserGroups()
    {
        ...
        $criteria->add(new TFilter('system_user_id', '=', $this->lgn_id));
    ...
    public static function authenticate($login, $password)
    {
        ...
        if ($user instanceof Usuario)
        {
            ...
            else if (isset( $user->lgn_senha ) AND ($user->lgn_senha == md5($password)) )
            {
                return $user;
            }
            else
    ...
    static public function newFromLogin($login)
    {
        ...
        $criteria = new TCriteria;
        $criteria->add(new TFilter('lgn_usuario', '=', $login));
