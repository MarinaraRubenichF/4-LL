...
class SystemDocument extends TRecord
{
    ...
    public function get_system_user()
    {
        ...
        $user = Usuario::find($this->system_user_id);
        TTransaction::close();
        return $user;
    }
     ...
     */
    public function addUsuario(Usuario $systemuser)
    {
        $object = new SystemDocumentUser;
        $object->system_user_id = $systemuser->lgn_id;
        $object->document_id = $this->id;
        $object->store();
    }
    ...
    public function getSystemUsersIds()
    {
        ...
        if ($users)
        {
            ...
            {
                $user_ids[$user->lgn_id] = $user->lgn_usr_nome;
            }
        }
        return $user_ids;
    }
    ...
    public function getSystemUsers()
    {
        ...
        if ($document_users)
        {
            ...
            {
                $users[] = new Usuario( $document_user->system_user_id );
            }
            TTransaction::close();
        }
        return $users;
