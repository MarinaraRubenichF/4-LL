...
class SystemDocumentList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $category_id = new TDBCombo('category_id', 'webrural', 'SystemDocumentCategory', 'id', 'descricao');
        ...
        $column_category_id = new TDataGridColumn('category->descricao', _t('Category'), 'center');
        ...
        {
            $column_user = new TDataGridColumn('system_user->lgn_usr_nome', _t('User'), 'left');
    ...
    public function onDownload($param)
    {
        try
        {
            if (isset($param['id']))
            {
                ...
                TTransaction::open('webrural'); // open a transaction
    ...
    public function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('webrural'); // open a transaction with database
